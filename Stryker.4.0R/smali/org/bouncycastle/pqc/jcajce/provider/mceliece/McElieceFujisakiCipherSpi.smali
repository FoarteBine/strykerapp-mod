...
.field public final Z:Lorg/bouncycastle/pqc/crypto/mceliece/McElieceFujisakiCipher;

.field public final x1:Ljava/io/ByteArrayOutputStream;


# direct methods
.method public constructor <init>(Lorg/bouncycastle/crypto/digests/SHA1Digest;Lorg/bouncycastle/pqc/crypto/mceliece/McElieceFujisakiCipher;)V
    .locals 0

    invoke-direct {p0}, Lorg/bouncycastle/pqc/jcajce/provider/util/AsymmetricHybridCipher;-><init>()V

    iput-object p1, p0, Lorg/bouncycastle/pqc/jcajce/provider/mceliece/McElieceFujisakiCipherSpi;->Y:Lorg/bouncycastle/crypto/Digest;

    iput-object p2, p0, Lorg/bouncycastle/pqc/jcajce/provider/mceliece/McElieceFujisakiCipherSpi;->Z:Lorg/bouncycastle/pqc/crypto/mceliece/McElieceFujisakiCipher;

    new-instance p1, Ljava/io/ByteArrayOutputStream;

    invoke-direct {p1}, Ljava/io/ByteArrayOutputStream;-><init>()V

    iput-object p1, p0, Lorg/bouncycastle/pqc/jcajce/provider/mceliece/McElieceFujisakiCipherSpi;->x1:Ljava/io/ByteArrayOutputStream;
...
.method public final b([BII)[B
    ...
    iget-object p1, p0, Lorg/bouncycastle/pqc/jcajce/provider/mceliece/McElieceFujisakiCipherSpi;->x1:Ljava/io/ByteArrayOutputStream;
    ...
    iget-object v0, p0, Lorg/bouncycastle/pqc/jcajce/provider/mceliece/McElieceFujisakiCipherSpi;->Z:Lorg/bouncycastle/pqc/crypto/mceliece/McElieceFujisakiCipher;

    if-ne p1, p3, :cond_0

    invoke-virtual {v0, p2}, Lorg/bouncycastle/pqc/crypto/mceliece/McElieceFujisakiCipher;->c([B)[B
    ...
    :try_start_0
    invoke-virtual {v0, p2}, Lorg/bouncycastle/pqc/crypto/mceliece/McElieceFujisakiCipher;->b([B)[B
...
.method public final l([BII)[B
    ...
    iget-object v0, p0, Lorg/bouncycastle/pqc/jcajce/provider/mceliece/McElieceFujisakiCipherSpi;->x1:Ljava/io/ByteArrayOutputStream;
...
.method public final o(Ljava/security/Key;)V
    ...
    iget-object v0, p0, Lorg/bouncycastle/pqc/jcajce/provider/mceliece/McElieceFujisakiCipherSpi;->Y:Lorg/bouncycastle/crypto/Digest;
    ...
    invoke-virtual {v0, v1, p1}, Lorg/bouncycastle/pqc/crypto/mceliece/McElieceFujisakiCipher;->a(ZLorg/bouncycastle/crypto/CipherParameters;)V
...
.method public final p(Ljava/security/Key;Ljava/security/SecureRandom;)V
    ...
    iget-object p1, p0, Lorg/bouncycastle/pqc/jcajce/provider/mceliece/McElieceFujisakiCipherSpi;->Y:Lorg/bouncycastle/crypto/Digest;

    invoke-interface {p1}, Lorg/bouncycastle/crypto/Digest;->reset()V

    iget-object p1, p0, Lorg/bouncycastle/pqc/jcajce/provider/mceliece/McElieceFujisakiCipherSpi;->Z:Lorg/bouncycastle/pqc/crypto/mceliece/McElieceFujisakiCipher;

    const/4 p2, 0x1

    invoke-virtual {p1, p2, v0}, Lorg/bouncycastle/pqc/crypto/mceliece/McElieceFujisakiCipher;->a(ZLorg/bouncycastle/crypto/CipherParameters;)V
