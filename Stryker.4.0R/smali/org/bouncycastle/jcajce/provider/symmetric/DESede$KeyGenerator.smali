...
.method public final engineGenerateKey()Ljavax/crypto/SecretKey;
    ...
    iget-object v2, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseKeyGenerator;->c:Lorg/bouncycastle/crypto/CipherKeyGenerator;
    ...
    iget v4, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseKeyGenerator;->b:I

    invoke-direct {v0, v4, v3}, Lorg/bouncycastle/crypto/KeyGenerationParameters;-><init>(ILjava/security/SecureRandom;)V

    invoke-virtual {v2, v0}, Lorg/bouncycastle/crypto/CipherKeyGenerator;->b(Lorg/bouncycastle/crypto/KeyGenerationParameters;)V

    iput-boolean v1, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseKeyGenerator;->d:Z

    :cond_0
    iget-boolean v0, p0, Lorg/bouncycastle/jcajce/provider/symmetric/DESede$KeyGenerator;->e:Z

    iget-object v3, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseKeyGenerator;->a:Ljava/lang/String;

    if-nez v0, :cond_1

    invoke-virtual {v2}, Lorg/bouncycastle/crypto/CipherKeyGenerator;->a()[B
